 ...
 * @since AM 5.5.0
 */
public class PreferredOTPPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(PreferredOTPPlugin.currentVersion, 
				Collections.singletonList(PreferredOTP.class));
	}
	...
	public String getPluginVersion() {
		return PreferredOTPPlugin.currentVersion;
	}
}
