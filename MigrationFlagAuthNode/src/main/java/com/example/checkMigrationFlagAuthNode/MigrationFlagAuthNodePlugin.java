 ...
 * @since AM 5.5.0
 */
public class MigrationFlagAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(MigrationFlagAuthNodePlugin.currentVersion, 
				Collections.singletonList(MigrationFlagAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return MigrationFlagAuthNodePlugin.currentVersion;
	}
}
